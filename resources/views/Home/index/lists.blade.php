                                            ...
                                            <div class="product-single style-2">
                                                <div class="row align-items-center m-0">
                                                    <div class="col-lg-4 p-0">
                                                        <div class="product-thumb"><a href="{{ route('web.goodsdetail', [$v->id]) }}"><img
                                                                        src="{{ $v->thumb_img }}" alt=""/></a></div>
                                                    </div>
                                                    <div class="col-lg-8 p-0">
                                                        <div class="product-title"><h4><a href="{{ route('web.goodsdetail', [$v->id]) }}">{{ $v->goods_name }}</a></h4></div>
                                                        <div class="product-price-rating"><span>￥{{ $v->present_price }}</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="brand-items">
                        ...
                        <div class="brand-item"><a href="{{ $v->id }}"><img class="brand-static" src="{{ $v->brand_img }}" alt="" width="40%"/></a></div>
                        @endforeach
                    </div>
                </div>
            </div>
