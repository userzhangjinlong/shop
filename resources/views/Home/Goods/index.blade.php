                ...
                <div class="col-xl-10 col-lg-9">
                    <div class="row align-items-center">
                        <div class="col-lg-2 col-md-6">
                            <div class="section-title"><h3>分类名称 是否需要展示？</h3></div>
                        </div>
                    ...
                    </div><!--recently-viewed-products-start-->
                    <div class="recent-viewed-products mt-50">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section-title"><h3>浏览记录</h3></div>
                            </div>
                        </div>
                    ...
                    </div><!--recently-viewed-products-end--></div>
            </div>
        </div>
