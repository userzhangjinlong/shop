    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="icon_document_alt"></i>广告列表</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <form action="{{ route('admin.adverList') }}" method="get">
                    <div class="col-lg-3">
                        <label>筛选:</label>
                            ...
                            @if(!empty($list))
                                @foreach($list as $v)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a class="btn btn-success" href="{{ route('admin.adverAdd', [$v->id]) }}"><i class="icon_pencil-edit_alt"></i></a>
