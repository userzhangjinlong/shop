...
<head>
    ...
    <link href="{{ asset('css/assets/fullcalendar.css') }}" rel="stylesheet">
    <!-- easy pie chart-->
...
<section id="container" class="">
    ...
    <header class="header dark-bg">
        ...
        <!--logo start-->
        <a href="/admin" class="logo">{{ config('app.name', 'LAN商城') }} {{--<span class="lite">Admin</span>--}}</a>
        <!--logo end-->
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu extended logout">
                        ...
                        <li>
                            <a href="{{ route('logout') }}"><i class="icon_key_alt"></i> 退出</a>
                        </li>
                        <li>
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="/admin/cateList">分类列表</a></li>
                        <li><a class="" href="/admin/cateAdd">添加分类</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="{{ route('admin.bannerList') }}">广告列表</a></li>
                        <li><a class="" href="{{ route('admin.bannerAdd') }}">新增广告</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
                    ...
                    <ul class="sub">
                        <li><a class="" href="{{ route('admin.brandList') }}">品牌列表</a></li>
                        <li><a class="" href="{{ route('admin.brandAdd') }}">新增品牌</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" class="">
...
<script src="{{ asset('js/assets/jquery.knob.js') }}"></script>
<script src="{{ asset('js/assets/jquery.easy-pie-chart.js') }}"></script>
<script src="{{ asset('js/jquery.sparkline.js') }}"></script>
<script src="{{ asset('js/owl.carousel.js') }}"></script>
<script src="{{ asset('js/fullcalendar.min.js') }}"></script>
<script src="{{ asset('js/assets/fullcalendar.js') }}"></script>
